...
function LoginModal({ isOpen, onClose}) {
    ...
    return (
        <Transition.Root show={isOpen} as={Fragment}>
            <Dialog as="div" className="relative z-10" onClose={() => {onClose(loggedInUserDetails)}}>
                <Transition.Child
                    as={Fragment}
                                ...
                                <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                                    <div className="sm:flex sm:items-start">
                                        <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                            ...
                                            <Dialog.Description>
                                                <div class="mb-4">
                                                <label htmlFor="loginKey" className="flex justify-start block mb-1 text-sm font-medium text-gray-900 dark:text-black">Nsec Key:</label>
                                                <input type="text"
                                                       id="loginKey"
                                                       onChange={
