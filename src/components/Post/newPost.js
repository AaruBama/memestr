...
const PostUpload = ({ isOpen, onClose}) => {
    ...
    const sendNewPostEvent = () => {
        ...
        let commentEvent = {
            ...
            tags: [["d","memestr"],["url", link],["p", uesrPublicKey], ["category", "memestrrr"]],
            content: title + " " + link,
        }
                                            ...
                                            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                                ...
                                                <Dialog.Description>
                                                    <div class="mb-4 required">
                                                        <label htmlFor="title" className="flex justify-start block mb-1 text-sm font-medium text-gray-900 dark:text-black">Title</label>
                                                        <input type="text"
                                                               id="title"
                                                               onChange={handleTitleChange}
                                                               value={title}
                                                               className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Title..." required={true} />
                                                    </div>
