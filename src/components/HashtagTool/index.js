            ...
            <div className="flex flex-col md:flex-row min-h-screen">
                ...
                <main className="flex-1 overflow-y-auto">
                    ...
                    <button
                        ...
                        title="Upload"
                        className="fixed z-50 bottom-12 right-3 md:right-8 bg-gradient-to-r from-blue-500 to-teal-500 hover:from-pink-500 hover:to-yellow-500 w-14 h-14 rounded-full flex items-center justify-center text-white drop-shadow-lg hover:drop-shadow-2xl md:bottom-4 ">
                        <UploadSvg />
                    </button>
