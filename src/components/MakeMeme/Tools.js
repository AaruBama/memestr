...
import { ReactComponent as GearIcon } from '../../Icons/Setting.svg';
...
const TextInput = ({
    ...
    return (
        <div className="mb-4 relative">
            <div className="flex items-center bg-gray-300 border pr-1">
                <input
                    type="text"
                    value={text.text}
                    onChange={e => onTextChange(text.id, e.target.value)}
                    placeholder="Enter text"
                    className="px-2 py-2 w-full border "
                />
                <div className="flex flex-nowrap items-center ">
                    <button
                        className="ml-1 p-2 bg-gray-200 hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-400"
                        onClick={() => togglePanel('gear')}>
                        <GearIcon className="w-6 h-6 text-gray-600" />
                    </button>
                    <button
                        className="ml-2 w-8 h-8 border-2 border-gray-300"
